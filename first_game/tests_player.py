...
class Player_Tests(unittest.TestCase):
    ...
    def test_collision_zones(self):
        ...
        for assertion in assertions:
            collision_zone = Player._get_collision_zone(assertion.boundary, assertion.rect)
    ...
    def test_no_collision_means_not_on_top_and_new_rect_unchanged(self):
        new_rect, on_top = Player._stick_and_get_new_position(
    ...
    def test_a_NW_collision_causes_a_W_stick_and_not_on_top(self):
        ...
        collision_zone = Player._get_collision_zone(Rect(10, 20, 10, 20), new_rect)
